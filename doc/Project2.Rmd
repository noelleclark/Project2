...
# Below from lines 35-39 is a loop within function to trim the extra spaces after character data from # the data set. Inputs are a data set with a column specified with a "$" and outputs are cleaned rows # within the columns that do not have unecessary space.
...
#Subset and cleaning data for sex colum 
...
##First plot 
```{r}
# This is a function from lines 57-75 which outputs a plot of all of the shark attacks by sex of the vixtim. This   # unction has arguments so that the x axis limits and title of the graph can be changed. The inputs  # # are:
